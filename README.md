# Polarity LinkedIn Integration

The Polarity LinkedIn integration uses the Google search API to search for emails, handles names and indicators on LinkedIn.
